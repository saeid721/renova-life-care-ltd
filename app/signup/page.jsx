    ...
    <>
      ...
      <section style={{ padding: '4rem 1rem', background: 'var(--bg-subtle)' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
          ...
          <Link href="/PatientPortal/patient-signup" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <Link href="/DoctorPortal/doctor-signup" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="panel-card" style={{ background: '#fff', borderRadius: '1rem', padding: '2.5rem 1.5rem', textAlign: 'center', boxShadow: 'var(--shadow-md)', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}>
          ...
          <Link href="/OutletPortal/outlet-signup" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="panel-card" style={{ background: '#fff', borderRadius: '1rem', padding: '2.5rem 1.5rem', textAlign: 'center', boxShadow: 'var(--shadow-md)', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}>
              ...
              <p style={{ color: 'var(--text-light)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Register your pharmacy or diagnostic center.</p>
              <span className="btn btn-primary" style={{ display: 'inline-flex', width: '100%', justifyContent: 'center', background: 'var(--success, #059669)', borderColor: 'var(--success, #059669)' }}>Sign Up</span>
            </div>
          </Link>

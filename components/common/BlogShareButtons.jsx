// components/blog/BlogShareButtons.jsx
"use client";
...
export default function BlogShareButtons({ title, url }) {
  ...
  return (
    <div className="blog-share-buttons">
      ...
      <button onClick={() => handleShare("whatsapp")} className="blog-share-btn" aria-label="Share on WhatsApp">
      ...
      <button 
        ...
        className={`blog-share-btn ${copied ? "blog-share-btn--copied" : ""}`} 
